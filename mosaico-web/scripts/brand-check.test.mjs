...
/* Os três testes que ficavam aqui verificavam .grok/skills/og/SKILL.md e
   AGENTS.md — documentação do andaime do template, removida do repositório
   em fc1d57b "Tira o andaime do mosaico-web". Eles falhavam desde então e
   ninguém viu, porque esta suíte nunca rodava no push. Agora roda. */

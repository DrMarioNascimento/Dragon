// @ts-nocheck — cópia byte a byte de v1/js/qr.js. Anotar tipos aqui faria
// as duas cópias divergirem, que é exatamente o que o teste de deriva
// existe para impedir. O corpo é ES5 conferido contra a norma.
/* CÓPIA de v1/js/qr.js para a noite (v2). O corpo é idêntico byte a byte
   até a linha do export; tests/qr.test.mjs confere as duas cópias e falha
   se elas se afastarem. Só a amarração muda: lá o codificador se pendura
   em window, aqui ele é um módulo — com sideEffects:false no pacote, um
   efeito no global seria removido pelo empacotador sem avisar. */
const MosaicoQR = /* Codificador de QR do MOSAICO — ISO/IEC 18004, modo byte.
